...
(async function (util, global, config, Canvas, color, gameDraw, socketStuff) {
    ...
    function drawMinimapAndDebug(spacing, alcoveSize, GRAPHDATA) {
        ...
        let watermarkText = "Arras Ciper Probe Version";
        ...
        if (global.showDebug) {
            ...
            drawText(watermarkText, x + len, y - 50 - 10 * 14 - 2, 15, watermarkColor, "right", false, 1, true);
            ...
            drawText(watermarkText, x + len, y - 50 - 4 * 14 - 2, 15, color.guiwhite, "right", true, 1, true);
            ...
            drawText(ping.toFixed(1) + " ms / " + global.serverStats.serverGamemodeName + " " + global.locationHash, x + len, y - 50, 10, color.guiwhite, "right");
        } else drawText(watermarkText, x + len, y - 22 - 2 * 14 - 2, 15, color.guiwhite, "right", true);
    }
