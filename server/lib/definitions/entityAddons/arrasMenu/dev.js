...
Class.arrasMenu_special = makeMenu("Special Menu", {upgrades: [Config.spawn_class, "arrasMenu_gameAdmin", "eggGen", "arrasMenu_specialTanks", "arrasMenu_bosses", "arrasMenu_nostalgia", "arrasMenu_scrapped", "arrasMenu_memes", dreadnoughts, "arrasMenu_shinyMember"]})
    ...
    Class.arrasMenu_specialTanks = makeMenu("Special Tanks Menu", {upgrades: ["arrasMenu_special", "arrasMenu_healers", "arrasMenu_dominators", "arrasMenu_sanctuaries", "arenaCloser", "bacteria", "literallyAMachineGun", "mothership", "flagship", "turkey"/*, "arrasMenu_developer"*/, "arrasPolice"]})
