...
// SANCTUARIES
const sancTiers = [3, 6, 8, 9, 10, 12];
const sancHealerTiers = [2, 3, 4];
for (const tier of sancHealerTiers) {
...
for (const tier of sancTiers) {
  const sancIndex = sancTiers.indexOf(tier);
