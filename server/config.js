module.exports = {
  ...
  servers: [ // Make sure to change the HOST, PORT and SERVER_ID between servers!
    ...
    },
    {
      ...
      id: "2tdmod", // (<HOST>/#<SERVER_ID>)
      featured: false,

      region: "local", // The region the server is on.
      gamemode: ["2tdmOneDominator"], // The selected gamemode.
      player_cap: 80, // Not including bots.
    ...
    },
    {
      ...
      host: "localhost:3005", // Server host location.
      port: 3005, // The port on the server.
      id: "aic2tdm", // (<HOST>/#<SERVER_ID>)
      featured: false,

      region: "local", // The region the server is on.
      gamemode: ["aic2tdm"], // The selected gamemode.
      player_cap: 80, // Not including bots.
    ...
    },
    {
      ...
      id: "aicffa", // (<HOST>/#<SERVER_ID>)
      featured: false,

      region: "local", // The region the server is on.
      gamemode: ["aicffa"], // The selected gamemode.
      player_cap: 80, // Not including bots.
    ...
    },
    {
      ...
      region: "local", // The region the server is on.
      gamemode: ["nostalgia"], // The selected gamemode.
      player_cap: 80, // Not including bots.
    ...
    },
    {
      ...
      host: "localhost:3008", // Server host location.
      port: 3008, // The port on the server.
      id: "bb", // (<HOST>/#<SERVER_ID>)
      featured: false,

      region: "local", // The region the server is on.
      gamemode: ["bossbattle"], // The selected gamemode.
      player_cap: 80, // Not including bots.
    ...
    },
    {
      ...
      host: "localhost:3009", // Server host location.
      port: 3009, // The port on the server.
      id: "stac", // (<HOST>/#<SERVER_ID>)
      featured: false,

      region: "local", // The region the server is on.
      gamemode: ["surviveArenaCloser"], // The selected gamemode.
      player_cap: 80, // Not including bots.

      properties: { // This overrides settings in the config.js file, providing the selected gamemode doesn't also override it.
        surviveArenaCloser: true,
        bot_cap: 32,
        teams: 1,
        bosses_spawn: false
      }
